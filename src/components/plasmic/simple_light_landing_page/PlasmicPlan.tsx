...
import BaseCard from "../../BaseCard"; // plasmic-import: TjDIMTB2HRizfW/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: DMfK4n3H-JQK9c/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___0C2U2)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lrCam)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__wqJpM)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__xb5Ue)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__lxcN9)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__x9L4J)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__jx5T)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__nEwAz)}
