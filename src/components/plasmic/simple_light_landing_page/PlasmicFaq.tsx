...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: betqEbJDIGTg2H/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ekBmD)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__pyTm5)}>
          <div className={classNames(projectcss.all, sty.freeBox__yYYoI)}>
            {p.renderPlasmicSlot({
