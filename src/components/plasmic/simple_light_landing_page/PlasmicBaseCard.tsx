...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: TjDIMTB2HRizfW/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__acLcq, {
          [sty.freeBoxlong__acLcqxxnNb]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___79OuO, {
            [sty.freeBoxlong___79OuOxxnNb]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__ovWaT)}
                role={"img"}
              />
            ),
