...
import Avatar from "../../Avatar"; // plasmic-import: ki14-PYANZx5U2/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: ZTFA8qQLC1KZGV/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: oLZgT-L4LRSOl-/icon
import profilepic8F16Nq6Pih9Ke from "./images/profilepic.png"; // plasmic-import: 8f-16NQ6pih9KE/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zFxxK)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hzurf)}
        >
          <div
            className={classNames(
              projectcss.all,
