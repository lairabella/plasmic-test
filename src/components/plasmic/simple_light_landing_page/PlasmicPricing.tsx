...
import Plan from "../../Plan"; // plasmic-import: DMfK4n3H-JQK9c/component
...
import Faq from "../../Faq"; // plasmic-import: betqEbJDIGTg2H/component
...
import sty from "./PlasmicPricing.module.css"; // plasmic-import: nIxiH-ZSCasFk8/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column___8UTg)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__ioMwz)}
                  price={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__oPicc)}
              ...
              <div className={classNames(projectcss.all, sty.column___5HaBk)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__ouLu)}
                  description={
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__igegE)}
                    color={"blue" as const}
                  >
                    {"Get started"}
                  </Button>
              ...
              <div className={classNames(projectcss.all, sty.column__un3Gy)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan___1Hbcf)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__vsH6R)}
                    color={"outlineBlue" as const}
                  >
                    {"Get started"}
                  </Button>
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__ozzun)}
            >
              <Faq
                className={classNames("__wab_instance", sty.faq__fnRdy)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__bvAu)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__fk5OD)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
